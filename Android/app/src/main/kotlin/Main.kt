...
open class MainActivity: AppCompatActivity {
    ...
    override fun onStart() {
        super.onStart()
        SkipNFirebaseUIAppDelegate.shared.onStart()
    }

    override fun onResume() {
        super.onResume()
        SkipNFirebaseUIAppDelegate.shared.onResume()
    }

    override fun onPause() {
        super.onPause()
        SkipNFirebaseUIAppDelegate.shared.onPause()
    }

    override fun onStop() {
        super.onStop()
        SkipNFirebaseUIAppDelegate.shared.onStop()
    }

    override fun onDestroy() {
        super.onDestroy()
        SkipNFirebaseUIAppDelegate.shared.onDestroy()
    }

    override fun onLowMemory() {
        super.onLowMemory()
        SkipNFirebaseUIAppDelegate.shared.onLowMemory()
    }
...
internal fun PresentationRootView(context: ComposeContext) {
    ...
    PresentationRoot(defaultColorScheme = colorScheme, context = context) { ctx ->
        ...
        Box(modifier = ctx.modifier.fillMaxSize(), contentAlignment = Alignment.Center) {
            SkipNFirebaseUIRootView().Compose(context = contentContext)
        }
    }
}
